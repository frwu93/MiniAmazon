...
class Fulfill:
    def __init__(self, id, product_id, buyer_id, buyer_address, time_ordered, price, quantity, fulfilled, name):
        self.id = id
    ...
    def get_all_by_uid_since(seller_id, since):
        rows = app.db.execute('''
SELECT order_id, product_id, buyer_id, address, time_ordered, price, quantity, fulfilled, name
FROM (SELECT order_id, buyer_id, time_ordered, product_id, o.price, o.quantity, fulfilled, seller_id, name
